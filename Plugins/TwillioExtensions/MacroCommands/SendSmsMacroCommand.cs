...
public class SendSmsMacroCommand
{
	...
	public static async Task SendTextMessage(string accountSid, string authToken, string toPhoneNumber, string fromPhoneNumber, string message, CancellationToken cancellationToken)
	{
